...
func BuildOperation(op Op, req *http.Request) (Operation, error) {
	oper := Operation{
		Oper: op,
	}
	val := int64(0)
...
func SendOperationResult(op Operation, w http.ResponseWriter) {
	switch op.Oper {
	case Add:
